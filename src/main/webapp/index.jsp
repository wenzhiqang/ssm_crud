		...
		<div class="container">
			...
			<div class="row">
				 <div class="col-md-4 col-md-offset-8">
				 	<button class="btn btn-info glyphicon glyphicon-plus" id="emps_add_model_but">新增</button>
				 	<button class="btn btn-danger glyphicon glyphicon-trash" id="emps_delect_all_but">删除</button>
				 </div>
			</div>
			<!-- 表格数据 -->
			<div class="row">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
					  ...
					  <div class="form-group">
					    <label class="col-sm-2 control-label">cmpName</label>
					    <div class="col-sm-10">
				      <input type="text" class="form-control" name="cmpName" id="cmpName_input" placeholder="cmpName">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
				      <input type="text" class="form-control" name="email" id="email_input_input" placeholder="email">
				       <span class="help-block"></span> 
					    </div>
					  </div>
					  
					   <div class="form-group">
					    <label class="col-sm-2 control-label">gttder</label>
					    <div class="col-sm-10">
				    		 <div class="radio">
								  <label>
								    <input type="radio" name="gttder" id="gttder1_add_input" value="1" checked>男
								  </label>
								</div>
								<div class="radio">
								  <label>
								    <input type="radio" name="gttder" id="gttder2_add_input" value="0">女
								  </label>
							</div>
					    </div>
					  </div>
			...
			<div class="modal fade" id="empUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
				      ...
				      <input type="text" class="form-control" name="email" id="email_Update_input" placeholder="email">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10">
				    		 <div class="radio">
								  <label>
								    <input type="radio" name="gttder" id="gttder1_Update_input" value="1" checked>男
								  </label>
								</div>
								<div class="radio">
								  <label>
								    <input type="radio" name="gttder" id="gttder2_Update_input" value="0">女
								  </label>
							</div>
					    </div>
					  </div>
					   <div class="form-group">
					    <label class="col-sm-2 control-label">deptName</label>
					    <div class="col-sm-4" id="updata_did" >
				    		 <select class="form-control" name="dId">
			      ...
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			        <button type="button" class="btn btn-primary" id="emp_uodata_btn1">修改</button>
			      </div>
			    </div>
			  </div>
			</div>
		...
		<script type="text/javascript">
			...
			function build_emps_table(result){
				...
				$.each(emps,function(index,itme){
					...
					var delBtu=$("<button></button>").addClass("btn btn-danger").append("<span></span>").addClass("glyphicon glyphicon-trash delete_but").append("删除");
...
// 				}); */
			...
			$("#emp_uodata_btn1").click(function (){
				...
				var datanew=$("#empUpdateModal form").serialize();
				if(datanew==data){
					alert("请选择编辑你要编辑的内容！");
				}else{
